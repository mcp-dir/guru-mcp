...
Digital Manager Guru segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Digital Manager Guru** | BR | checkout/sales-management platform API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [guru@mcp.ai](mailto:guru@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
